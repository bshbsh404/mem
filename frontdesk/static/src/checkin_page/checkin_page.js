...
export class CheckIn extends Component {
    ...
    async uploadQrData() {
        const result = await this.rpc(`${this.props.frontdeskUrl}/frontdesk_check_in`, {
            qrCode: this.qrCode
        });
...
CheckIn.template = "frontdesk.CheckIn";
CheckIn.props = {
...
registry.category("frontdesk_screens").add("CheckIn", CheckIn);
